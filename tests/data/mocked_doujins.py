...
with open('./tests/data/nhentai_search_mock.html', 'r') as search:
    nhentai_search_mocked = search.read()

with open('./tests/data/nhentai_search_no_result.html', 'r') as no_result:
...
with open('./tests/data/nhentai_author_page_mock.html', 'r') as author:
    nhentai_author_mocked = author.read()

with open('./tests/data/nhentai_author_page_not_found_mock.html', 'r') as author_not_found:
    nhentai_author_not_found_mocked = author_not_found.read()

with open('./tests/data/manganato_manga_page_empty_chapters_mock.html', 'r') as empty_ch:
    manganato_manga_page_empty_chapters_mocked = empty_ch.read()

with open('./tests/data/manganato_manga_page_empty_pagination_mock.html', 'r') as empty_pag:

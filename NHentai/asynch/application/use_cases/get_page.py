...
from NHentai.asynch.infra.adapters.brokers.implementations.pubsub import PubSubMessage, Image, Source, Images, Title
...
class GetPageUseCase:
    ...
    async def send_to_pubsub(self, page: Page):
        try:
            for doujin in page.doujins:
